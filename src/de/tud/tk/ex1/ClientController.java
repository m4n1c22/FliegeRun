...
public class ClientController extends UnicastRemoteObject implements ClientCallbackInterface {
	...
	public static void main(String[] args) throws RemoteException {
		...
		clientViewObj.addListener(new ClientViewEventTriggerAdaptor() {
			...
			// Called from the mouseClickedEvent and mouseDraggedEvent
			// Methods....
			@Override
			public void callFliegeHunted() {
	...
	public void updatePlayerInfo(ArrayList<Player> playerList) {
		...
		for (Player P : playerList) {
			...
			// playerListString.concat(P.getPlayerName() + "\t" +
