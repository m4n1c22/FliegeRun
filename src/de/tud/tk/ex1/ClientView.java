...
public class ClientView {
	...
	// Call this method when you get the callback from server for new position
	// of Fliege...
	static int i = 0, j = 0;
	// private static Fliege fliege;
	 ...
	 * 
	 * // NOTE: Usually this should be a field rather than a method // variable
	 * so that it is not re-seeded every call. Random rand = new Random();
	 * 
	 * // nextInt is normally exclusive of the top value, // so add 1 to make it
	 * inclusive int randomNum = rand.nextInt((max - min) + 1) + min;
	 * 
	 * return randomNum; }
	 */
	...
	//
	// FliegeImg.setBounds(new Rectangle(new Point(200, 300),
	// FliegeImg.getPreferredSize()));
	...
	/*
	 * public static void setPositionForMouseEventWithLabel(MouseEvent e,JLabel
	 * L) {
	 * 
	 * 
	...
	public static void initialiseUIForPlayer() {
		...
		/*
		 * f.setSize(521, 387); f.setLocation(300,200);
		 */
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addComponent(panel_1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 683,
										Short.MAX_VALUE)
